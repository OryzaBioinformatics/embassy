...
static void eomegapp_doquals(AjPStr *cl, OmegaOQual[]);

static void eomegapp_dobool(AjPStr *cl, OmegaOQual qual);
static void eomegapp_dotoggle(AjPStr *cl, OmegaOQual qual);
static void eomegapp_dostring(AjPStr *cl, OmegaOQual qual);
static void eomegapp_doinfile(AjPStr *cl, OmegaOQual qual);
...
{
    {TYPE_BOOL, eomegapp_dobool},
    {TYPE_TOGGLE, eomegapp_dotoggle},
    {TYPE_INT, eomegapp_dointeger},
    {TYPE_FLOAT, eomegapp_dofloat},
...
int main(int argc, char **argv)
{
    ...
    embInitPV("eomegapp", argc, argv, "CLUSTALOMEGA",VERSION);
    ...
    eomegapp_doquals(&cl, omegaqualsgeneral);
    eomegapp_doquals(&cl, omegaqualsadv);
...
static void eomegapp_doquals(AjPStr *cl, OmegaOQual omegaquals[])
{
    ajuint i;
...
/* @funcstatic eomegapp_dodirectory *******************************************
**
** Get ACD directories.
** Only add to command line if value different from the default
**
...
/* @funcstatic eomegapp_dolistsingle *****************************************
**
