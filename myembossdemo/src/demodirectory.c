/* @source demodirectory application
**
** Demonstration of how the directory datatype should be used.
...
int main (int argc, char *argv[]) 
{
    ...
    embInitPV("demodirectory", argc, argv, "myembossdemo", VERSION);

    dir = ajAcdGetDirectory("infile");
    outfile = ajAcdGetOutfile("outfile");

    filelist = ajListstrNew();
    ajFilelistAddDirectory(filelist, dir);
