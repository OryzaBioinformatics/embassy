...
/* RCS $Id: getopt.c,v 1.1.1.1 2001/12/24 09:05:38 ableasby Exp $
 */
...
/* Function: SqdBanner()
 * 
 * Purpose:  Print the SQUID version and copyright banner.
...
SqdBanner(FILE *fp, char *banner)
{
  ...
  fprintf(fp, "SQUID is freely distributed under the GNU General Public License (GPL).\n");
  printf("- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -\n");
}
