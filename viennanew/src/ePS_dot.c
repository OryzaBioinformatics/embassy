...
PUBLIC int   gmlRNA(char *string, char *structure, AjPFile ssfile, char option);
PUBLIC int   PS_rna_plot_a(char *string, char *structure, AjPFile ssfile,
			   char *pre, char *post);
PUBLIC int   PS_rna_plot(char *string, char *structure, AjPFile ssfile);
PUBLIC int   ssv_rna_plot(char *string, char *structure, AjPFile ssfile);
PUBLIC int   xrna_plot(char *string, char *structure, AjPFile ssfile);
...
PUBLIC int   PS_dot_plot(char *string, AjPFile wastlfile);
PUBLIC int   PS_color_dot_plot(char *seq, cpair *pi, AjPFile wastlfile);
PUBLIC int   PS_dot_plot_list(char *string, AjPFile wastlfile, struct plist *pl,
			      struct plist *mf, char *comment);
PUBLIC int   PS_dot_plot_turn(char *seq, struct plist *pl, AjPFile wastlfile,
			      int winSize);

/* local functions */
PRIVATE void   loop(int i, int j, short *pair_table);
PRIVATE FILE  *PS_dot_common(char *seq, AjPFile wastlfile, char *comment,
			     int winsize);
...
/*---------------------------------------------------------------------------*/
int PS_rna_plot(char *string, char *structure, AjPFile ssfile) {
...
int svg_rna_plot(char *string, char *structure, AjPFile ssfile)
{
  float  xmin, xmax, ymin, ymax, size;
  int    i, length;
  float *X, *Y;
...
int PS_dot_plot(char *string, AjPFile wastlfile) {
...
/*---------------------------------------------------------------------------*/
int PS_color_dot_plot(char *seq, cpair *pi, AjPFile wastlfile) {
...
int PS_color_dot_plot_turn(char *seq, cpair *pi, AjPFile wastlfile, int winSize) {
  /* produce color PostScript dot plot from cpair */
...
int PS_dot_plot_turn(char *seq, struct plist *pl, AjPFile wastlfile, int winSize) {
  /* produce color PostScript dot plot from cpair */
...
static FILE * PS_dot_common(char *seq, AjPFile wastlfile,
...
#include "pair_mat.h"
#include "aln_util.h"
int PS_color_aln(const char *structure, AjPFile filename, 
