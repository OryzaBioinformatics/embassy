...
/*@unused@*/
#if 0
static char rcsid[] = "$Id: vrnacofold.c,v 1.15 2011/07/06 14:18:46 rice Exp $";
#endif
...
/*    AjBool paired; */
    ...
    embInitPV("ovrnacofold",argc,argv,"VIENNA",VERSION);
...
PRIVATE void do_concentrations(double FEAB, double FEAA, double FEBB, double FEA, double FEB, double *startconc, AjPFile outf) {
  ...
  ajFmtPrintF(outf,"Initial concentrations\t\trelative "
